...
config = dict(
    ...
    pretrain = r"/home/liujierui/proj/SegBuild_master/output/model/hrnet_w48_ocr_up4_default_4_w9_pesudo_highscore_2_continue_24000.pth",         #file/path of the pretrain model
    multi_gpu = True,
