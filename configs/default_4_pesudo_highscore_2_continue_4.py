...
config = dict(
    ...
    pretrain = r"/home/liujierui/proj/SegBuild_master/output/model/hrnet_w48_ocr_up4_default_4_pesudo_highscore_2_continue_3_42000.pth",         #file/path of the pretrain model
    multi_gpu = True,
    device_ids = [1], # 默认第一位作为主卡

    # Solver 
    enable_swa = False,
    criterion = dict(type="CrossEntropy_ocr", num_outputs = 2,balance_weights=[0.2,1.2]),
