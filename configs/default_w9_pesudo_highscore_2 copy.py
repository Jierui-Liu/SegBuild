...
config = dict(
    ...
    train_pipeline = dict(
        ...
        dataset = dict(type="load_dataAll",
                    ...
                    # pseudo_label
                    pseudo_image_dir = r"/home/liujierui/proj/Dataset/test_dataset_npy/image_bin", pseudo_mask_dir = r"/home/liujierui/proj/SegBuild_master/exp/result_8228",  
    ...
    # pretrain = r"/home/liujierui/proj/SegBuild_master/model/HRNet_ocr/models/pretrain_model/f_epoch_4_1024rescale512labelsmooth_hrnet_w48_ocr.pth",         #file/path of the pretrain model
    multi_gpu = True,
    device_ids = [2], # 默认第一位作为主卡

    # Solver
    enable_swa = False,
    criterion = dict(type="CrossEntropy_ocr", num_outputs = 2,balance_weights=[0.4,1.0]),
    lr_scheduler = dict(type="CyclicLR",base_lr=1e-6,max_lr=1e-2,step_size_up=4000,mode='triangular2',cycle_momentum=True), # cycle_momentum=False if optimizer==Adam
