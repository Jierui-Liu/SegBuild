...
config = dict(
    ...
    train_pipeline = dict(
        ...
        dataset = dict(type="load_dataAll",
                    ...
                    # extra_datasets --> List[]
                    extra_image_dir_list = [r"/home/chenbangdong/cbd/DrivenDATA/agriculture_data/image",r"/home/chenbangdong/cbd/DrivenDATA/AerialImageDataset/image_bin"],  extra_mask_dir_list = [r"/home/chenbangdong/cbd/DrivenDATA/agriculture_data/label",r"/home/chenbangdong/cbd/DrivenDATA/AerialImageDataset/label_bin"],   
        ),
        batch_size = 8,
        shuffle = True,
        num_workers = 12,
