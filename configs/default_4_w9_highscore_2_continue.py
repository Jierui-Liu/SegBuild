...
config = dict(
    ...
    pretrain = r"/home/liujierui/proj/SegBuild_master/output/model/hrnet_w48_ocr_up4_default_4_w9_highscore_2_24000.pth",         #file/path of the pretrain model
    multi_gpu = True,
    device_ids = [0], # 默认第一位作为主卡

    # Solver actually ##################not w9 but w10
    enable_swa = False,
