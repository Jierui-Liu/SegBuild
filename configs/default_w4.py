...
config = dict(
    ...
    train_pipeline = dict(
        ...
        dataset = dict(type="load_dataAll",
                    ...
                    # pseudo_label
                    # pseudo_image_dir = r"/home/chenbangdong/cbd/DrivenDATA/test_dataset_npy/image_bin", pseudo_mask_dir = r"/home/l/deeplearning_1/cbd/LinHonghui/SegBulid_jr/result_ensemble_0.7843",  
    ...
    lr_scheduler = dict(type="CyclicLR",base_lr=1e-6,max_lr=1e-2/3,step_size_up=3500,mode='triangular2',cycle_momentum=True), # cycle_momentum=False if optimizer==Adam
