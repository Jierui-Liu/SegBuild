...
config = dict(
    ...
    train_pipeline = dict(
        transforms = [
                    ...
                    dict(type="Rescale",output_size=(1024,1024)),
                    dict(type="ToTensor",),
        ...
        dataset = dict(type="load_dataAll",
                    ...
                    #  train_1_image_dir = r'/home/l/deeplearning_1/cbd/DrivenDATA/dataset2/image_bin',train_1_mask_dir = r'/home/l/deeplearning_1/cbd/DrivenDATA/dataset2/label_bin', 
                    # train_2
                    ...
                    # pseudo_label
                    # pseudo_image_dir = r"/home/liujierui/proj/Dataset/test_dataset_npy/image_bin", pseudo_mask_dir = r"/home/liujierui/proj/SegBuild_master/exp/lll",  
                    # pseudo_image_dir = r"", pseudo_mask_dir = r"",  
                    # extra_datasets --> List[]
                    # extra_image_dir_list = [r"/home/liujierui/proj/Dataset/agriculture_data/image"],  extra_mask_dir_list = [r"/home/liujierui/proj/Dataset/agriculture_data/label"],   
    ...
    test_pipeline = dict(
        ...
        dataset = dict(type="load_Inference_dataset",
                    ...
                    #  test_image_dir = r"/home/l/deeplearning_1/cbd/DrivenDATA/test_dataset_npy/image_bin"
                    ),
        batch_size = 4,
        shuffle = False,
        num_workers = 8,
    ...
    # pretrain = r"/home/l/deeplearning_1/cbd/LinHonghui/SegBuild_master/model/HRNet_ocr/models/pretrain_model/f_1025rescale512_epoch_6__hrnet_w48_ocr.pth",         #file/path of the pretrain model
    # pretrain = r"/home/l/deeplearning_1/cbd/LinHonghui/SegBuild_master/output/model/hrnet_w48_ocr_up4_default_w95_pesudo_highscore_3_28000.pth",         #file/path of the pretrain model
    multi_gpu = True,
    device_ids = [0], # 默认第一位作为主卡

    # Solver
    enable_swa = False,
    criterion = dict(type="CrossEntropy_ocr", num_outputs = 2,balance_weights=[0.2,1.0]),
    lr_scheduler = dict(type="CyclicLR",base_lr=1e-6,max_lr=(1e-2)/6,step_size_up=20000,mode='triangular2',cycle_momentum=True), # cycle_momentum=False if optimizer==Adam
