...
config = dict(
    ...
    lr_scheduler = dict(type="CyclicLR",base_lr=1e-6,max_lr=(1e-2)/2,step_size_up=4000,mode='triangular2',cycle_momentum=True), # cycle_momentum=False if optimizer==Adam
