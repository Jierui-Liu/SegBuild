...
config = dict(
    ...
    train_pipeline = dict(
        ...
        dataset = dict(type="load_dataAll",
                    ...
                    # pseudo_label
                    pseudo_image_dir = r"/home/liujierui/proj/Dataset/test_dataset_npy/image_bin", pseudo_mask_dir = r"/home/liujierui/proj/SegBuild_master/exp/result_8348",  
    ...
    pretrain = r"/home/liujierui/proj/SegBuild_master/output/model/hrnet_w48_ocr_up4_default_4_pesudo_highscore_2_continue_6_18000.pth",         #file/path of the pretrain model
    multi_gpu = True,
    ...
    lr_scheduler = dict(type="CyclicLR",base_lr=1e-6,max_lr=(1e-2)/4,step_size_up=4000,mode='triangular2',cycle_momentum=True), # cycle_momentum=False if optimizer==Adam
