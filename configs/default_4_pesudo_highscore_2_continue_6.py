...
config = dict(
    ...
    pretrain = r"/home/liujierui/proj/SegBuild_master/output/model/hrnet_w48_ocr_up4_default_4_pesudo_highscore_2_continue_5_18000.pth",         #file/path of the pretrain model
    multi_gpu = True,
    ...
    lr_scheduler = dict(type="CyclicLR",base_lr=1e-6,max_lr=(1e-2)/3,step_size_up=4500,mode='triangular2',cycle_momentum=True), # cycle_momentum=False if optimizer==Adam
