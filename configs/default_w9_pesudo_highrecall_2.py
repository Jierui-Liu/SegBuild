...
config = dict(
    ...
    train_pipeline = dict(
        ...
        dataset = dict(type="load_dataAll",
                    ...
                    # pseudo_label
                    pseudo_image_dir = r"/home/liujierui/proj/Dataset/test_dataset_npy/image_bin", pseudo_mask_dir = r"/home/liujierui/proj/SegBuild_master/exp/result_ensemble_highrecall",  
