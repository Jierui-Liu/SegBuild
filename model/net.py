import sys
sys.path.append(r"/home/chenbangdong/cbd/LinHonghui/DrivenData_2020_SegBulid/SegBuild/")

import torch
import torch.nn as nn
from model.HRNet.models.seg_hrnet import get_seg_model,get_seg_attention_model
...
class hrnet_w48_up8_attention_stage3(nn.Module):
    def __init__(self,num_classes=2,freeze_num_layers=0):
        super(hrnet_w48_up8_attention_stage3,self).__init__()
        self.num_classes = num_classes
        self.freeze_num_layers = freeze_num_layers

        config.merge_from_file(r"/home/chenbangdong/cbd/LinHonghui/DrivenData_2020_SegBulid/SegBuild/model/HRNet/hrnet_config/seg_hrnet_w48_train_ohem_512x1024_sgd_lr1e-2_wd5e-4_bs_12_epoch484.yaml")
        self.hrnet_w48 = get_seg_attention_model(config)
        state_dict = self.hrnet_w48.state_dict()
